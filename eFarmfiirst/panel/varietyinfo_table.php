...
<div class="content">
<?php
								$result = mysqli_query($mysqli,"SELECT * FROM variety_info");
								//$result2 = mysqli_query($con, "SELECT county, COUNT(*) FROM record GROUP BY county");

								
								echo "<table border='1' class='table table-bordered'> 
								<h4>Variety Information Table</h4>
						        <thead> 
								<tr> 
								<th>Variety Info ID</th> 
								<th>Variety id</th> 								
								<th>Variety Information</th> 
								<th>Delete</th> 
								</tr> 
								</thead>";  
								...
								echo "<td>" . $row['var_info'] . "</td>";   
								echo '<td><a href="delete_varietyinfo.php?var_id='.$row["var_id"].'"onClick="return confirm(\'are you sure you want to delete this entry from the database?\')"><img src="delete.png"></a></td>';
								echo "</tr>";  
								echo "</tbody>";	
