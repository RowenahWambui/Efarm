...
<?php
								...
								echo "<td>" . $row['seedling_name'] . "</td>";  
								echo '<td><a href="delete_seed.php?seedling_id='.$row["seedling_id"].'"onClick="return confirm(\'are you sure you want to delete this entry from the database?\')"><img src="delete.png"></a></td>';
								echo "</tr>";  
								echo "</tbody>";	
