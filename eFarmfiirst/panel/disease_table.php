...
<div class="content">
<?php
								$result = mysqli_query($mysqli,"SELECT * FROM cropdiseases");
								...
								echo '<td><a href="delete_disease.php?diseaseid='.$row["diseaseid"].'"onClick="return confirm(\'are you sure you want to delete this entry from the database?\')"><img src="delete.png"></a></td>';
								echo "</tr>";  
								echo "</tbody>";	
