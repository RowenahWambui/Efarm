...
<div class="content">
<?php
								$result = mysqli_query($mysqli,"SELECT * FROM disease_info");
								//$result2 = mysqli_query($con, "SELECT county, COUNT(*) FROM record GROUP BY county");

								
								echo "<table border='1' class='table table-bordered'> 
								<h4>Disease Information Table</h4>
						        <thead> 
								<tr> 
								<th>Id</th> 
								<th>Disease Id</th> 								
								...
								echo "<td>" . $row['textinfo'] . "</td>";   
								echo '<td><a href="delete_diseaseinfo.php?id_count='.$row["id_count"].'"onClick="return confirm(\'are you sure you want to delete this entry from the database?\')"><img src="delete.png"></a></td>';
								echo "</tr>";  
								echo "</tbody>";	
